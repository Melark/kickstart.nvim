...
require('lazy').setup({
  ...
  -- Avante setup (using Copilot.lua as provider)
  {
    'yetone/avante.nvim',
    event = 'VeryLazy',
    dependencies = {
      ...
      'zbirenbaum/copilot.lua', -- important!
    },
    build = 'make',
    opts = {
      provider = 'copilot',
    ...
    keys = {
      { '<leader>ac', '<cmd>AvanteChat<cr>', desc = 'Avante Chat (Copilot)' },
      { '<leader>aa', '<cmd>AvanteAsk<cr>', desc = 'Ask Avante (Copilot)' },
      { '<leader>ae', '<cmd>AvanteEdit<cr>', desc = 'Avante Edit (Copilot)' },
    },
  },
